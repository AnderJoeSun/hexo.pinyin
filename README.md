# 为hexo博客定制的汉字拼音排序
1. 更新：pinyin默认支持中文或拼音排序，但它提供的比较器（compare函数）只支持字符串作为参数，而我需要对hexo博客中的所有的标签进行排序，而每个标签都是一个对象。于是我修改了compare函数以支持hexo

2. 详细[使用说明](https://zhengnian.me/2015/12/25/source.projects.of.this.blog/)

3. [排序效果](https://zhengnian.me/tag/)
